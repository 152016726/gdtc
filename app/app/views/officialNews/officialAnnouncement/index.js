...
export class OfficialAnnouncement extends Component {
...
export default connectReducerComponent(storeKey.OFFICIAL_STORE, reducer, state, action)(OfficialAnnouncement)